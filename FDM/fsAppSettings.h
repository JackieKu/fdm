...
public:
	...
	void Convert_Extension (LPCSTR psz);
	CString Convert_Extension();
	void Convert_VideoCodec (LPCSTR psz);
	CString Convert_VideoCodec();
	void Convert_AudioCodec (LPCSTR psz);
	...
	void Convert_Format (LPCSTR psz);
	...
	fsTUM CurrentTUM();
	BOOL Get_TUM(fsTrafficUsageMode aTUM[3]);
	void Set_TUM (fsTrafficUsageMode aTUM [3]);
