...
public:
	...
	int RARProcessFile (HANDLE hArcData,int Operation,TCHAR *DestPath,TCHAR *DestName);
...
protected:
	...
	typedef int    (PASCAL *FNRARPF)(HANDLE hArcData,int Operation,TCHAR *DestPath,TCHAR *DestName);
